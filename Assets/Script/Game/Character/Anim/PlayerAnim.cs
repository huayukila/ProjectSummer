...
public class PlayerAnim : CharacterAnim
{
    ...
    private void Awake()
    {
        ...
        _respawnShadow = Instantiate(GameResourceSystem.Instance.GetPrefabResource("PlayerShadow"), Vector3.zero, Quaternion.identity);
        ...
        TypeEventSystem.Instance.Register<SendInitializedPlayerEvent>
            (
                eve =>
                {
                    PlayerInterfaceContainer playerInterfaces = eve.Player.GetComponent<IPlayerInterfaceContainer>().GetContainer();
